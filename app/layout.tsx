...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://prizm-design.in",
  },
  ...
  openGraph: {
    ...
    url: "https://prizm-design.in",

    siteName: "The PRIZM Design Studio",
  ...
  twitter: {
    ...
    title: "The PRIZM Design Studio | Luxury Interior Designers in Mumbai",
    description:
      "Refined Mumbai interiors, architecture, and turnkey design. ESTD 2012.",
    images: [
      "https://images.unsplash.com/photo-1745301558339-44eb3217d5da?auto=format&fit=crop&w=1600&q=80",
    ],
  },
